...
int main()
{
    ...
    multimap<uint16_t, string> the_eight_planets{
        {1, "Mercury"},
        {2, "Venus"},
        {3, "Earth"},
        {4, "Mars"},
    ...
    multimap<int, int, less<int>> numbers_2{
        {1, 10},
        {2, 20},
        {4, 40},
        {5, 50},
    ...
    multimap<double, double, std::function<bool(double, double)>> floating_points(
